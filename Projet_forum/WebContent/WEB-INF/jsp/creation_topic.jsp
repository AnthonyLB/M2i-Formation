				...
				<form action="#" method="post">
					...
					<table class="tablebg" cellspacing="1" width="100%">
						<tbody>
							...
							<tr>
								<td class="row2">
									...
									<table style="width: 100%;" cellspacing="1" cellpadding="4" align="center">
										<tbody>
											<tr>
												<td valign="top"><b class="gensmall">Titre : </b></td>
												<td><input class="post" name="title" size="25" tabindex="1" type="text" /></td>
											</tr>
											<tr>
												<td valign="top"><b class="gensmall">Contenu : </b></td>
												<td><input class="post" name="contenu" size="100" tabindex="2" type="text" /></td>
											</tr>
							...
							<tr>
								<td class="cat" colspan="2" align="center"><input name="Post" class="btnmain" value="Ajouter votre topic" tabindex="5" type="submit" /></td>
							</tr>
						</tbody>
					</table>

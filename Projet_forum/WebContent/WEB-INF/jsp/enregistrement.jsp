				...
				<form action="#" method="post">
					...
					<table class="tablebg" cellspacing="1" width="100%">
						<tbody>
									...
									<table style="width: 100%;" cellspacing="1" cellpadding="4" align="center">
										<tbody>
											<tr>
												...
												<td><input class="post" name="email" size="25" tabindex="2" type="text" /></td>
											</tr>
											<tr>
							...
							<tr>
								<td class="cat" colspan="2" align="center"><input name="enregistrement" class="btnmain" value="Enregistrer" tabindex="5" type="submit" /></td>
							</tr>
						</tbody>
					</table>

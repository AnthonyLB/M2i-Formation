...
<%@ page import="fr.acceis.forum.model.FilDiscussion" %>
		...
		<div id="wrapcentre">	
			...
			<div id="pagecontent">
				...
				<table cellspacing="1" width="100%">
					<tbody>
						<tr>
							<td valign="middle" align="left" colspan="4" nowrap="nowrap"><a href="/forum/creation_topic"><img src="fichiers/button_topic_new.gif" alt="Post new topic" title="Post new topic" /></a>&nbsp;<a href="/forum/creation_post?id=${param.id}"><img src="fichiers/button_topic_reply.gif" alt="Reply to topic" title="Reply to topic" /></a>
				...
				<custom:posts idFilDiscussion="${param.id}" /> <!-- param.id equivaut a request.getParameter("id") -->
			</table>
